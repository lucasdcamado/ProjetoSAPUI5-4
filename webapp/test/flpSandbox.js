		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Projeto Simple Form",
									"targetURL": "#sapfiorisimpleform1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapfiorisimpleform1-display": {
								"semanticObject": "sapfiorisimpleform1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.fiori.simpleform1",
									"url": sap.ui.require.toUrl("sap/fiori/simpleform1")
								}
							}
						}
					}
